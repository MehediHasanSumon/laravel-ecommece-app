...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Add a new product to your store</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full border @error('slug') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="slug" name="slug" value="{{ old('slug') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full border @error('sku') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="sku" name="sku" value="{{ old('sku') }}" required>
                        @error('sku')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" step="0.01" min="0" class="w-full pl-7 border @error('price') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="price" name="price" value="{{ old('price') }}" required>
                            </div>
                            @error('price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" step="0.01" min="0" class="w-full pl-7 border @error('sale_price') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="sale_price" name="sale_price" value="{{ old('sale_price') }}">
                            </div>
                            @error('sale_price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" min="0" class="w-full border @error('stock_quantity') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" required>
                ...
                <div>
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span id="main-image-filename" class="text-sm text-gray-500">No file selected</span>
                        </div>
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full border @error('short_description') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="short_description" name="short_description" rows="3">{{ old('short_description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full border @error('description') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="description" name="description" rows="6">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex space-x-6 mb-4">
                            ...
                            <div class="flex items-center">
                                <input id="is_featured" name="is_featured" type="checkbox" value="1" {{ old('is_featured') == '1' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
